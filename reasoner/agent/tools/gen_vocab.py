...
acute_angle = ['AcuteAngle1', 'AcuteAngle2', 'AcuteAngle3', 'AcuteAngle4', 'AcuteAngle5', 'AcuteAngle6', 'AcuteAngle7', 'AcuteAngle8', 'AcuteAngle9', 'AcuteAngle10']
obtuse_angle = ['ObtuseAngle1', 'ObtuseAngle2', 'ObtuseAngle3', 'ObtuseAngle4', 'ObtuseAngle5', 'ObtuseAngle6', 'ObtuseAngle7', 'ObtuseAngle8', 'ObtuseAngle9', 'ObtuseAngle10']
...
# var = []
constant = ['Constant1', 'Constant2', 'Constant3', 'Constant4', 'Constant5', 'Constant6', 'Constant7', 'Constant8', 'Constant9', 'Constant10']
node_type_vocab = ['[PAD]', '[CLS]'] + ['Point', 'Triangle', 'Circle', 'Arc', 'Polygon', 'Line', 'Angle']
node_attr_vocab = ['None', '30', '45', '60', '90', '120', '135', '150', '180', '210', '240', '270', '300', '330', 'x', 'y', 'z', 'h', 'r', 'p', 'd', 's', 'Var'] + acute_angle + obtuse_angle + reflex_angle + constant
edge_attr_vocab = ['None', 'CLS', 'SELF'] + ['Connected', 'Equal', 'Perpendicular', 'Parallel', 'Congruent', 'Similar', 'LiesOnLine', 'LiesOnLine_R', 'LiesOnCircle', 'LiesOnCircle_R', 'Center', 'Center_R',  'Interior', 'Interior_R', 'Endpoint', 'Endpoint_R', 'Sidepoint', 'Sidepoint_R', 'Side', 'Side_R', 'Vertex', 'Vertex_R']
